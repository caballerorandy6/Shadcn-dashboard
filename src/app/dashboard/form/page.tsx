...
const formSchema = z
  ...
  .refine((data) => data.marketingEmails === true, {
    //Validación personalizada. Se puede usar para validar que un campo sea true o false
...
export default function Page() {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      username: "",
      email: "",
      // gender: "male", //Se puede definir un valor por defecto o comentarlo para no tener valor por defecto
